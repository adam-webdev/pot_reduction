...
require.cache[require.resolve("app/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("app/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
